...
`)+`
`+u);const S=T+f+a,A=T+u+o,O=ya(r,r.VERTEX_SHADER,S),w=ya(r,r.FRAGMENT_SHADER,A);r.attachShader(M,O),r.attachShader(M,w),t.index0AttributeName!==void 0?r.bindAttribLocation(M,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(M,0,"position"),r.linkProgram(M);function R(C){if(i.debug.checkShaderErrors){const V=r.getProgramInfoLog(M).trim(),z=r.getShaderInfoLog(O).trim(),K=r.getShaderInfoLog(w).trim();let Y=!0,k=!0;if(r.getProgramParameter(M,r.LINK_STATUS)===!1)if(Y=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,M,O,w);else{const Z=Ta(r,O,"vertex"),H=Ta(r,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(M,r.VALIDATE_STATUS)+`
